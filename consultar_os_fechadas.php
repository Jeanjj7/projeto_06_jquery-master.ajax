...
$sql = "SELECT * FROM tb_ordens_de_servicos WHERE status_os='Fechada'";
...
try{
    ...
    foreach ($resultados as $item) {
        ...
        <b>Status:</b> <span class='status_os' style='color: red;'>$status_os</span><br>
            <button id='bntReabriOs' id_os='$id_os'>Reabri OS</button>
        </div>
        ";
    }
